...
\pgfqkeys{/VorlageVersion5}{
	...
	all/Untertitel 					= {Eine \LaTeX-Vorlage mit vielen vordefinierten Befehlen\par Version~5.6},
	all/VersionPraefix 				= {},
	all/Version 					= {false},
	all/Icon/Breite					= {1},
...
Aenean massa. Cum sociis natoque penatibus et magnis.     \qed
		...
		\section{Gängige Abkürzungen}
			...
			\begin{tabbing}
				...
				\verb|\sob|, \verb|\Sob|		\> siehe oben 					\> \verb|\so| ist im Paket \texttt{soul} für 			\\
				\verb|\su|, \verb|\Su|			\> siehe unten					\> \so{gesperrt} reserviert.				\\
