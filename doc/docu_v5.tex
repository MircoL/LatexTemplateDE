...
\pgfqkeys{/VorlageVersion5}{
	...
	all/Untertitel 					= {Eine \LaTeX-Vorlage mit vielen vordefinierten Befehlen\par Version~5.14},
	all/VersionPraefix 				= {},
	all/Version 					= {false},
	all/Icon/Breite					= {1},
...
\begin{document}
	...
	\chapter{Grundeinstellungen für Dokumente}
		...
		\begin{center}
			\vspace*{20em}
			\subsection{Beispiel zu \tt Thesis}
		\end{center}
	...
	\section{Dokumenteinstellungen}
		...
		\subsection{Arrays}
			...
			\begin{tabbing}
				mmmmmmmmmmmmmmm			\= mmmmmmmmmmmmmmmmm					\=	mmmmmmmmmm			\kill
				\bf Name des Arrays		\> \bf Inhalt 							\> \bf Dokumentklassen	\\
				 all/Autoren			\> Die Autoren der Dokumente			\> alle					\\
				 Thesis/EingereichtBei	\> Prof., bei dem eingereicht wird		\> \tt Thesis 			\\
				 Thesis/BetreuungDurch	\> Die Betreuer der Thesis				\> \tt Thesis
			\end{tabbing}
		\subsection{Pgfkeys}
			...
			\begin{tabbing}
				...
				Thesis/Versicherung/zeigen		\> Zeige die Versicherung der Eigenleistung.
																						\> boolean			\\
				Thesis/Versicherung/text		\> Text der Versicherung (\siu).		\> string			\\
			...
			\begin{itemize}
				...
				\item Wird die Anzeige der Versicherung eingeschaltet, aber kein Text angegeben, so erscheint ein Standardtext (Siehe Muster im Kap. \vref{thesis-bsp})
			\end{itemize}
     ...
     description={
       ...
       \Classdef{org.example.java.test.Functions}{
         ...
         description={
            ...
            Außerdem gibt es noch diese Variable:\\
