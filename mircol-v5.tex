...
\AtBeginDocument{
	...
	\begingroup
		...
		\checkbool{\get{Thesis/Versicherung/zeigen}}
		% ------------------------------------------------------------------------
		...
		{Thesis}{%
			...
			\begin{center}
				\ifthenelse{\equal{\get{Thesis/AkademischerGrad/kurz}}{}}{}{%
					\get{Thesis/AkademischerGrad/kurz}arbeit zur Erlangung des akademischen Grades\par%
					eines \get{Thesis/AkademischerGrad/lang} \get{Thesis/Fach/Genitiv}%
				}
				\\
				...
				\ifthenelse{\equal{\get{all/Untertitel}}{}}{}{\vspace*{.5em}{\large\bf\get{all/Untertitel}\par}}
				\vspace*{.5em}
				{\bf \Large \get{Thesis/AkademischerGrad/kurz}arbeit von %
					\StrSubstitute{\get{all/Autoren}}{&}{\par}%
				}
			\end{center}
			
			\begin{tabular}{ll}
				Eingereicht bei: & \multicolumn{1}{p{11cm}}{\eingereichtBei} \\
				Betreuung durch: & \multicolumn{1}{p{11cm}}{\betreuungDurch} \\
				Abgabedatum:	 & \get{Thesis/Abgabedatum}
			\end{tabular}
			\begin{flushright}
				\ifthenelse{\equal{\get{Skript/AnmerkungenTitelseite}}{}}{}{{\em \vspace*{1em}\get{Skript/AnmerkungenTitelseite}\par}}
